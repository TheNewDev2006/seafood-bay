        ...
        <div class="container-fluid clearfix">
            ...
            <div class="header-inner rel d-flex align-items-center">
                <div class="logo-outer">
                    <div class="logo">
                        <a href="{{ route('home') }}">
                            ...
                            @else
                                <span class="logo-text" style="font-size: 24px; font-weight: bold; color: #fff;">{{ $personalization['business_name'] ?? 'Restaurant' }}</span>
                            @endif
                        </a>
                    </div>
                </div>
                        ...
                        <div class="navbar-header py-10">
                            <div class="mobile-logo">
                                <a href="{{ route('home') }}">
                                    ...
                                    @else
                                        <span class="logo-text" style="font-size: 20px; font-weight: bold; color: #fff;">{{ $personalization['business_name'] ?? 'Restaurant' }}</span>
                                    @endif
                                </a>
                            </div>
                ...
                <div class="menu-btns">
                    ...
                    <a href="{{ route('contact') }}" class="theme-btn">Book now <i class="far fa-arrow-alt-right"></i></a>
                    <!-- menu sidbar -->
