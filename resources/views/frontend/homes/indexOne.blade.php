                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content text-white" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <h1>{{ $personalization['tagline'] ?? 'Delicious Food Near Your Town' }}</h1>
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose-content rmb-30" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="about-btn-author mb-60">
                                <a href="{{ route('about') }}" class="theme-btn">learn more us <i class="far fa-arrow-alt-right"></i></a>
                                <div class="author">
                                    <img src="{{ asset('/assets/images/about/author.jpg') }}" alt="Author">
                                    <h6>{{ $personalization['business_name'] ?? 'Cynix Inc' }} Team / <span>CEO & Founder</span></h6>
                                </div>
                            </div>
                            <div class="row">
