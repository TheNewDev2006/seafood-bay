                            ...
                            <div class="contact-info-wrap">
                                ...
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6><a href="{{ url('mailto:supportinfo@gmail.com') }}">supportinfo@gmail.com</a><br> <a href="{{ url('mailto:finslaninfo.com') }}">finslaninfo.com</a></h6>
                                    </div>
                                </div>
                                <div class="contact-info-item">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6><a href="{{ url('callto:+88012345688') }}">+880 (123) 456 88</a><br> <a href="{{ url('callto:+00045685999') }}">+000 (456) 859 99</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
